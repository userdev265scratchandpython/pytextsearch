...
This tool does NOT use regex due to regex being too complicated for everyone
This software is designed to mimic the behavior/behaviour of the Grep program cross-platform without compatibility layers.

---

## Copyright

pytextsearch is licensed under **GPLv3**
© 2026 userdev265scratchandpython
All forks MUST remain FREE and OPEN-SOURCE.
Selling this software, a fork of it or a copy of it is prohibited.
...
- Do **_NOT_** add some code that plans to modify the user's system, this doesn't need any of that.
...
## Documentation
[documentation](./docs/default.md "Docs list")